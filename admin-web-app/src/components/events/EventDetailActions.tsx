  ...
  return (
    <div className="flex flex-col gap-sm">
      <Link
        ...
        className="interactive h-10 px-lg rounded-sm bg-primary text-white font-data text-[13px] font-semibold hover:bg-primary-hover transition-colors flex items-center justify-center"
      >
        Edit event
      </Link>
      <button
