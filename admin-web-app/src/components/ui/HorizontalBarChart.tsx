...
/** Ported verbatim from `admin/components/ui/HorizontalBarChart.tsx`. */
import { motion, useReducedMotion } from 'framer-motion';
import { useHasMounted } from '@/hooks/useHasMounted';
import type { NamedBar } from '@/lib/mock-data';

const shell = 'bg-bg-surface border border-border-outline rounded-md p-lg flex flex-col gap-md';
