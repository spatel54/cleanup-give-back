/** Shared field styling for EventForm and its sub-fields (address, photo). */
export const FIELD =
...
export const LABEL = 'font-data text-[11px] tracking-[0.88px] uppercase text-text-tertiary mb-xs block';
